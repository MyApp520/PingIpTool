...
public class OneSelectAdapter extends BaseQuickAdapter<StudentBean, BaseViewHolder> {
    ...
    public OneSelectAdapter(int layoutResId, @Nullable List<StudentBean> data) {
